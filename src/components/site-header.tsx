  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 rounded-2xl px-4 py-3 sm:px-6 glass-subtle">
        <Link
          href="#"
          className="shrink-0 rounded-lg outline-none ring-gold/0 transition hover:opacity-95 focus-visible:ring-2 focus-visible:ring-gold/40"
          aria-label="Moonora home"
        >
          <MoonoraLogo size="sm" />
        </Link>
