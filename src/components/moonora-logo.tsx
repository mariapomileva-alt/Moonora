...
/**
 * Wordmark: gold serif “Moonora” + optional arc and star (matches hero key art style).
 * Use on your site if you own this brand / artwork (your own creation = fine to use).
 */
export function MoonoraLogo({ className = "", size = "sm", withArc = true }: MoonoraLogoProps) {
